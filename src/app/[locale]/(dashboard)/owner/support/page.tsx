...
export default async function OwnerSupportPage() {
  ...
  const ticketsData = tickets.map((t) => ({
    id: t.id, organizationId: t.organizationId, subject: t.subject, message: t.message,
    status: t.status, priority: t.priority, createdBy: t.createdBy,
    assignedTo: t.assignedTo, createdAt: t.createdAt.toISOString(),
    organization: { name: t.organization.name },
