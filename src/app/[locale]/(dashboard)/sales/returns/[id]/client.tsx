...
export function SalesReturnViewClient({ ret: initial }: Props) {
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{t("returnInfo")} {generateNumber("SR", initial.number)}</h2>
