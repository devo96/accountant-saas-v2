...
type Props = { customers: Customer[]; items: Item[]; taxCodes: TaxCode[]; paymentTerms: PaymentTerm[]; branches: Branch[] };
...
export function NewInvoiceClient({ customers, items, taxCodes, paymentTerms, branches }: Props) {
