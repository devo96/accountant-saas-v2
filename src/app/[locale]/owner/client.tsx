  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="p-2 rounded-lg bg-green-50"><TrendingUp className="h-5 w-5 text-green-600" /></div><div><p className="text-xs text-gray-500">{t("mrr")}</p><p className="text-lg font-bold">{formatCurrency(mrr)}</p></div></div></CardContent></Card>
        <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="p-2 rounded-lg bg-primary-50"><Calendar className="h-5 w-5 text-primary-600" /></div><div><p className="text-xs text-gray-500">{t("arr")}</p><p className="text-lg font-bold">{formatCurrency(arr)}</p></div></div></CardContent></Card>
        <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="p-2 rounded-lg bg-red-50"><Percent className="h-5 w-5 text-red-500" /></div><div><p className="text-xs text-gray-500">{t("churnRate")}</p><p className="text-lg font-bold">{churnRate}%</p></div></div></CardContent></Card>
        <Card><CardContent className="p-4"><div className="flex items-center gap-3"><div className="p-2 rounded-lg bg-purple-50"><Activity className="h-5 w-5 text-purple-500" /></div><div><p className="text-xs text-gray-500">{t("liveOps")}</p><p className="text-lg font-bold">{liveOps.journals + liveOps.invoices}</p></div></div></CardContent></Card>
      </div>
